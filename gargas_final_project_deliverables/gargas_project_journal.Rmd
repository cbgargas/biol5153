...
for file in /home/cbg/projects/bacteria-diatom-16s/data/tol_rrna/*.fa  
...
I ran the above scriptusing the follow command in the terminal:  
...
I then ran the following commands to find the total number of sequences for Archaea and Bacteria in the dataset.  
...
The *-lengths.txt files were imported into the following .r code to create the following distribution plots:    
...
a99.250.len <- read.delim("/home/cbg/projects/bacteria-diatom-16s/data/cdhit/cdhit-c99/archaea-250bp-cd-len.txt", header=FALSE)
a99.500.len <- read.delim("/home/cbg/projects/bacteria-diatom-16s/data/cdhit/cdhit-c99/archaea-500bp-cd-len.txt", header=FALSE)
b99.250.len <- read.delim("/home/cbg/projects/bacteria-diatom-16s/data/cdhit/cdhit-c99/bacteria-250bp-cd-len.txt", header=FALSE)
b99.500.len <- read.delim("/home/cbg/projects/bacteria-diatom-16s/data/cdhit/cdhit-c99/bacteria-500bp-cd-len.txt", header=FALSE)

a98.250.len <- read.delim("/home/cbg/projects/bacteria-diatom-16s/data/cdhit/cdhit-c98/archaea-250bp-cd-len.txt", header=FALSE)
a98.500.len <- read.delim("/home/cbg/projects/bacteria-diatom-16s/data/cdhit/cdhit-c98/archaea-500bp-cd-len.txt", header=FALSE)
b98.250.len <- read.delim("/home/cbg/projects/bacteria-diatom-16s/data/cdhit/cdhit-c98/bacteria-250bp-cd-len.txt", header=FALSE)
b98.500.len <- read.delim("/home/cbg/projects/bacteria-diatom-16s/data/cdhit/cdhit-c98/bacteria-500bp-cd-len.txt", header=FALSE)

a97.250.len <- read.delim("/home/cbg/projects/bacteria-diatom-16s/data/cdhit/cdhit-c97/archaea-250bp-cd-len.txt", header=FALSE)
a97.500.len <- read.delim("/home/cbg/projects/bacteria-diatom-16s/data/cdhit/cdhit-c97/archaea-500bp-cd-len.txt", header=FALSE)
b97.250.len <- read.delim("/home/cbg/projects/bacteria-diatom-16s/data/cdhit/cdhit-c97/bacteria-250bp-cd-len.txt", header=FALSE)
b97.500.len <- read.delim("/home/cbg/projects/bacteria-diatom-16s/data/cdhit/cdhit-c97/bacteria-500bp-cd-len.txt", header=FALSE)
