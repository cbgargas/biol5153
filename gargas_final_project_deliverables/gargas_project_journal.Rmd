...
To fix these issues I created a python script to correct these issues and then output corrected fasta and tree files. This script also produces a CSV file containing all the extra info from the sequence headers.  
This python script is __'LTP_fasta_and_tree_renamer.py'__
...
The file containing this code is named "ssu-align-bash-script-assembly.sh" and contains the code blocked below:  
<pre><code>#! /bin/bash
...
I then used the following codes to concatenate the bacterial and archael sequences for each analysis... 
...
...then I made a .sh script (compare-analyses.sh) to grep ">" for each file to figure out the difference in # of bacterial and archaeic sequences between analyses.  
...
Kingdom | All | 250bp | 500bp  
--- | --- | --- | ---  
Archaea | 67 | 57 | 31  
Bacteria | 18385 | 11865 | 2508  
...
Originally, I concatenated all of the archaea and bacteria sequences for each minimum length using the following .sh script  
